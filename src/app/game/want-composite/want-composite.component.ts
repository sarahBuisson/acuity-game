...
import {maybeDoneBuilder, Wanted, WantedClick, WantedComposite, WantedKeyPress} from '../../../domain/model';
...
export class WantCompositeComponent extends AbstractWantComponent<WantedComposite> implements OnInit {
  ...
  maybePartDone(wanted: Wanted): (Event) => boolean {

    return ($event: Event) => {
      return maybeDoneBuilder(wanted)($event);
    };
  }
